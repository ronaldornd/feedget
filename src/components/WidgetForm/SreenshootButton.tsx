...
export function ScreenshootButton({screenshoot, onScreenshootTook}: ScreenshootButtonProps) {
    ...
    <button
        ...
        className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-zinc-900">
